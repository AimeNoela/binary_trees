 ...
 * left child, the existing left child is moved down one level to the left of the
 * new node.
 *
...
binary_tree_t *binary_tree_insert_left(binary_tree_t *parent, int value)
{
	...
	if (parent->left != NULL)
	{
		new_node->left = parent->left;      /* New node's left child becomes the existing left child */
		parent->left->parent = new_node;    /*Existing left child's parent becomes the new node */
	}
